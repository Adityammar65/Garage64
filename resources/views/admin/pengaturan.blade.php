...
@section('content')
    <div class="flex flex-col">
        ...
        <div class="flex flex-col gap-1 text-white mt-8">
        ...
        <div class="flex justify-center">
            <a href="{{ url('/') }}"
                class="bg-red-500 mt-8 p-2 rounded-md text-center w-1/2 mx-auto hover:bg-red-400 font-bold text-white text-sm rounded-md px-3 py-2">
                Logout
            </a>
        </div>
    </div>
