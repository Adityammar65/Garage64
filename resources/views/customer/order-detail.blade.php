    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        <div>
            <div class="flex items-center gap-3 mb-1">
                <a href="{{ url('/customer/orders') }}" class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition">
            ...
            <p class="text-gray-500 dark:text-gray-400 ml-8">#INV-002</p>
        </div>
        <span class="inline-flex items-center gap-1.5 text-sm font-medium px-4 py-2 rounded-full bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-400">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
                ...
                <div class="relative">
                    ...
                    <div class="space-y-8">
                        @php
                            $timeline = [
                                ['status' => 'Pesanan Dibuat', 'desc' => 'Pesanan berhasil dibuat', 'time' => '29 Mei 2026, 14:23', 'done' => true],
                                ['status' => 'Pembayaran Diverifikasi', 'desc' => 'Pembayaran telah dikonfirmasi', 'time' => '29 Mei 2026, 15:10', 'done' => true],
                                ['status' => 'Pesanan Diproses', 'desc' => 'Pesanan sedang diproses oleh tim kami', 'time' => '30 Mei 2026, 09:00', 'done' => true],
                                ['status' => 'Pesanan Dikirim', 'desc' => 'Pesanan dalam perjalanan ke alamat tujuan', 'time' => '-', 'done' => false],
                                ['status' => 'Pesanan Selesai', 'desc' => 'Pesanan telah diterima', 'time' => '-', 'done' => false],
                            ];
                        @endphp
                        ...
                        <div class="relative flex items-start gap-4">
                            <div class="relative z-10 flex-shrink-0">
                                ...
                                @elseif ($index === 3)
                                    <div class="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center shadow-md animate-pulse">
                            ...
                            <div class="flex-1 min-w-0 pt-1">
                                <p class="text-sm font-semibold text-gray-900 dark:text-white">{{ $item['status'] }}</p>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
                ...
                <div class="divide-y divide-gray-100 dark:divide-gray-700">
                    @php
                        $items = [
                            ['name' => 'Land Rover Defender 110', 'variant' => 'Brown Metallic - MIJO Special Edition', 'qty' => 2, 'price' => 'Rp 160.000', 'subtotal' => 'Rp 320.000'],
                            ['name' => 'Porsche 911 GT3 R (992) #77', 'variant' => 'AO Racing 2025', 'qty' => 1, 'price' => 'Rp 320.000', 'subtotal' => 'Rp 320.000'],
                        ];
                    @endphp
                    ...
                    <div class="p-4 flex items-center gap-4">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">{{ $item['variant'] }}</p>
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Qty: {{ $item['qty'] }} x {{ $item['price'] }}</p>
                        </div>
                        <p class="text-sm font-semibold text-gray-900 dark:text-white flex-shrink-0">{{ $item['subtotal'] }}</p>
                    </div>
                    @endforeach
                </div>
            </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-5">
                ...
                <div class="space-y-3 text-sm">
                    <div class="flex justify-between">
                        ...
                        <span class="text-gray-900 dark:text-white font-medium">Andi Pratama</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-500 dark:text-gray-400">Email</span>
                        <span class="text-gray-900 dark:text-white">andi@email.com</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-500 dark:text-gray-400">Telepon</span>
                        <span class="text-gray-900 dark:text-white">+62 812-3456-7890</span>
                    </div>
                    <div class="pt-3 border-t border-gray-100 dark:border-gray-700">
                        <p class="text-gray-500 dark:text-gray-400 mb-1">Alamat Pengiriman</p>
                        <p class="text-gray-900 dark:text-white">Jl. Merdeka No. 45, RT 03 RW 07, Kel. Gondokusuman, Kec. Umbulharjo, Yogyakarta, DIY 55166</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-5">
                ...
                <div class="space-y-3 text-sm">
                    <div class="flex justify-between">
                        ...
                        <span class="text-gray-900 dark:text-white">Rp 640.000</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-500 dark:text-gray-400">Ongkos Kirim</span>
                        <span class="text-gray-900 dark:text-white">Rp 25.000</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-500 dark:text-gray-400">Biaya Layanan</span>
                        <span class="text-gray-900 dark:text-white">Rp 5.000</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-500 dark:text-gray-400">Diskon</span>
                        <span class="text-green-600 dark:text-green-400">-Rp 30.000</span>
                    </div>
                    <div class="pt-3 border-t border-gray-100 dark:border-gray-700 flex justify-between">
                        <span class="font-semibold text-gray-900 dark:text-white">Total</span>
                        <span class="font-bold text-lg text-red-600 dark:text-red-400">Rp 640.000</span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-5">
                ...
                <div class="flex items-center gap-3 p-3 rounded-lg bg-gray-50 dark:bg-gray-700/50">
                    ...
                    <div>
                        <p class="text-sm font-medium text-gray-900 dark:text-white">Transfer Bank BCA</p>
                        <p class="text-xs text-gray-500 dark:text-gray-400">a.n. Garage64 • 1234567890</p>
                    </div>
                </div>
                <div class="mt-3 p-3 rounded-lg bg-green-50 dark:bg-green-900/20 border border-green-100 dark:border-green-900/30">
                    <div class="flex items-center gap-2">
                        <svg class="w-4 h-4 text-green-600 dark:text-green-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                        <p class="text-xs text-green-700 dark:text-green-400">Pembayaran telah diverifikasi</p>
                    </div>
                </div>
            </div>
            ...
            {{-- Tombol Aksi --}}
            <div class="space-y-3">
                <a href="#" class="w-full inline-flex items-center justify-center gap-2 bg-red-500 hover:bg-red-600 transition text-white px-5 py-2.5 rounded-lg font-medium shadow-md hover:shadow-lg text-sm">
                ...
                <a href="#" class="w-full inline-flex items-center justify-center gap-2 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 transition text-gray-700 dark:text-gray-300 px-5 py-2.5 rounded-lg font-medium text-sm">
